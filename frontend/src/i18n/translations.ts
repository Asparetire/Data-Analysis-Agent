...
const STRINGS = {
  zh: {
    ...
    'sidebar.deleteSessionConfirm': '确定删除会话「{name}」?此操作不可恢复。',
    'sidebar.sessionsEmpty': '还没有会话,点"新建对话"开始。',
    'sidebar.refresh': '刷新',
    'sidebar.untitledSession': '新对话',
    ...
    'analysis.collapse': '收起数据预览',
    'analysis.expand': '展开数据预览',
    'common.cancel': '取消',
    'common.confirm': '确认',
  ...
  en: {
    ...
    'sidebar.deleteSessionConfirm': 'Delete session "{name}"? This cannot be undone.',
    'sidebar.sessionsEmpty': 'No sessions yet. Click "New chat" to start.',
    'sidebar.refresh': 'Refresh',
    'sidebar.untitledSession': 'New chat',
    ...
    'analysis.collapse': 'Collapse preview',
    'analysis.expand': 'Expand preview',
